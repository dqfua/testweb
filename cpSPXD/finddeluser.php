...
while( $cNeoSQLConnectODBC->FetchRow() )
{
    ...
    printf("<TR style='background-color:#%s'>
            ...
            เมนูการจัดการ : 
            <a href='home.php?pid=undel&membernum=%d' onclick='if ( !confirmText(\"ต้องการเรียกไอดี %s กลับสู่ระบบแน่หรือไม่\") ) return false;'>เรียกกลับ</a> , 
			<a href='home.php?pid=deldata&membernum=%d' onclick='if ( !confirmText(\"ต้องการลบข้อมูลของลูกค้า %s  แน่นอนแล้วหรือไม่\") ) return false;'>ลบข้อมูล</a>
            </div>
            </TD>
            </TR>"
            ,$color
