...
<table width="600" border="0" cellpadding="0" cellspacing="3" bgcolor="#000000">
  <tr>
  <td>
	<div align="center"><b>ประวัติการย้ายโรงเรียน แสดงล่าสุด 20 รายการ</b></div>
    </td>
    </tr>
    </table>
<table width="600" border="0" cellpadding="0" cellspacing="3" bgcolor="#000000">
  <tr>
    ...
    <td width="87" align="center"><strong>โรงเรียนปัจจุบัน</strong></td>
    <td width="96" align="center"><strong>เปลี่ยนเป็นโรงเรียน</strong></td>
...
$szTemp = sprintf("SELECT TOP 20 * FROM Log_ChangeSchool WHERE MemNum = %d AND UserNum = %d ORDER BY LogNum DESC",$_CONFIG["SERVERMAN"]["SERVER_MEMNUM"],$UserNum);
...
while( $cNeoSQLConnectODBC->FetchRow() )
{
	...
	$School = $cNeoSQLConnectODBC->Result("School",ODBC_RETYPE_INT);
	$ToSchool = $cNeoSQLConnectODBC->Result("ToSchool",ODBC_RETYPE_INT);
...
?>
  <tr>
    ...
    <td align="center"><?php echo $_CONFIG["SCHOOL"][$School]; ?></td>
    <td align="center"><?php echo $_CONFIG["SCHOOL"][$ToSchool]; ?></td>
