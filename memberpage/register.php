...
if ( $nSubmit == 1 )
{
	...
	if ( !CGlobal::CheckStrManLen( $g_id , 11 ) ) die( "Oh!! เสียใจด้วยไอดีของคุณไม่ถูกต้อง" );
	if ( !CGlobal::CheckStrManLen( $g_pass , 11 ) ) die( "Oh!! เสียใจด้วยรหัสเข้าเกมส์ของคุณไม่ถูกต้อง" );
	if ( !CGlobal::CheckStrManLen( $g_passdel , 11 ) ) die( "Oh!! เสียใจด้วยรหัสลบตัวละครของคุณไม่ถูกต้อง" );
	...
	if ( strlen($g_email) > 100 ) die( "Oh!! อีเมล์ของคุณยาวเกิน" );
...
$cNeoSQLConnectODBC->ConnectRanUser( $cWeb->GetRanUser_IP(), $cWeb->GetRanUser_User(), $cWeb->GetRanUser_Pass(), $cWeb->GetRanUser_DB() );
	...
	$szTemp = sprintf( "INSERT INTO UserInfo( MemNum , UserID , UserPass , UserPass2 , UserEmail , RegisterIP , ParentID ) VALUES( '%s','%s','%s','%s','%s','%s','%s' )"
																								,$MemNum
																								,$g_id
																								,$g_passnormal
																								,$g_pass2normal
      ...
      <form id="form_register" name="form_register" method="post" action="">
        <table width="550" border="0" cellpadding="5" cellspacing="5">
          <tr>
            ...
            <td width="322" align="left"><input name="id" type="text" id="id" size="11" style="width:169px;" />
              <font color="#FF0000" size="-1"><b>* ภาษาอังกฤษ 4 - 11 ตัว</b></font></td>
          </tr>
          <tr>
            <td align="right"><strong>รหัสเข้าเกมส์ :</strong></td>
            <td align="left"><input name="pass" type="password" id="pass" size="11" style="width:169px;" />
              <font color="#FF0000" size="-1"><b>* ภาษาอังกฤษ 4 - 11 ตัว</b></font></td>
          </tr>
          <tr>
            <td align="right"><strong>ยืนยันรหัสเข้าเกมส์ :</strong></td>
            <td align="left"><input name="pass2" type="password" id="pass2" size="11" style="width:169px;" /></td>
          </tr>
          <tr>
            <td align="right" valign="top"><strong>รหัสลบตัวละคร</strong></td>
            <td align="left"><input name="passdel" type="password" id="passdel" size="11" style="width:169px;"/><font color="red"><b> **สำคัญมาก ห้ามใส่ 1234</b></font>                
            </td>
          </tr>
          <tr>
            <td align="right" valign="top"><strong>ยืนยัน-รหัสลบตัวละคร</strong></td>
            <td align="left"><input name="repassdel" type="password" id="repassdel" size="11" style="width:169px;"/>
            </td>
          </tr>
          <tr>
            <td align="right"><strong>อีเมล์ :</strong></td>
            <td align="left"><input name="email" type="text" id="email" size="32" style="width:169px;" /><br />
            <font color="#ffa500">จำเป็นต้องใช้ในการกู้รหัสผ่าน!!</font></td>
          </tr>
<?php
...
?>
          <tr>
            <td align="right"><strong>รหัสภาพ :</strong></td>
            <td align="left" valign="middle">
<?php
Captcha::ShowQuickCaptcha( $_CONFIG["REGISTER"]["SESSION"] );
?>
<br />
...
?>
          ...
          <tr>
			...
			/*
			  ...
			  */
			  ?>
              <input type="button" name="button" id="button" value="สมัครไอดี" onclick="regcccckk( <?php echo $MemNum; ?> );" />
            </label></td>
            <td align="left">
