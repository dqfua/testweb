...
<table width="600" border="0" cellpadding="0" cellspacing="3" bgcolor="#000000">
  <tr>
  <td>
	<div align="center"><b>ประวัติการเปลี่ยนชื่อ แสดงล่าสุด 20 รายการ</b></div>
    </td>
    </tr>
    </table>
<table width="600" border="0" cellpadding="0" cellspacing="3" bgcolor="#000000">
  <tr>
    ...
    <td width="73" align="center"><strong>ชื่อก่อนเปลี่ยน</strong></td>
    <td width="87" align="center"><strong>เปลี่ยนเป็น</strong></td>
    <td width="96" align="center"><strong>พ้อยก่อนเปลี่ยน</strong></td>
    <td width="75" align="center"><strong>พ้อยหลังเปลี่ยน</strong></td>
  </tr>
<?php
$cWeb = new CNeoWeb;
...
$szTemp = sprintf("SELECT TOP 20 * FROM Log_ChangeName WHERE MemNum = %d AND UserNum = %d ORDER BY LogNum DESC",$_CONFIG["SERVERMAN"]["SERVER_MEMNUM"],$UserNum);
...
while( $cNeoSQLConnectODBC->FetchRow() )
{
	...
	$OldChaName = $cNeoSQLConnectODBC->Result("OldChaName",ODBC_RETYPE_THAI);
	$NewChaName = $cNeoSQLConnectODBC->Result("NewChaName",ODBC_RETYPE_THAI);
...
?>
  <tr>
    ...
    <td align="center"><?php echo $OldChaName; ?></td>
    <td align="center"><?php echo $NewChaName; ?></td>
