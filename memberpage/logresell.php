...
<table width="600" border="0" cellpadding="0" cellspacing="3" bgcolor="#000000">
  <tr>
  <td>
	<div align="center"><b>ประวัติการขายไอเทมคืน แสดงล่าสุด 20 รายการ</b></div>
    </td>
    </tr>
    </table>
<table width="600" border="0" cellpadding="0" cellspacing="3" bgcolor="#000000">
  <tr>
    ...
    <td width="96" align="center"><strong>ชื่อไอเทม</strong></td>
    <td width="96" align="center"><strong>ราคา</strong></td>
...
$szTemp = sprintf("SELECT TOP 20 * FROM Log_Resell WHERE MemNum = %d AND UserNum = %d ORDER BY LogNum DESC",$_CONFIG["SERVERMAN"]["SERVER_MEMNUM"],$UserNum);
