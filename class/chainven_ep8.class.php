...
define("CHAINVEN_ITEM_SLOT",160);
define("CHAINVEN_VERSION",0x0113);
define("CHAINVEN_MAXITEM",48);
define("INVEN_X",5);
define("INVEN_Y",8);
define("ITEM_ERROR",-1);

$PIECE_POS_TYPE = array( "หัว" , "เสื้อ" , "กางเกง" , "ถุงมือ" , "รองเท้า" , "อาวุธ" , "สร้อยคอ" , "ต่างหู" , "แหวน R" , "แหวน L" , "Belt" , "Earring" , "Accessory" , "Extra 1" , "Extra 2"  );
...
class _CNeoChaInven
{
	...
	public function UpdateBinaryItemSlot( $i )
	{
		...
		//$cNeoSerialMemory->WriteByte( $this->Item_DummyC7[$i] );
                //dwowverid
          	$cNeoSerialMemory->WriteInt( $this->Item_dwOwnerID[$i] );
	...
	public function LoadNode_0112( $i , &$cNeoSerialMemory )
	{
			...
			//$this->Item_DummyC7[$i] = $cNeoSerialMemory->ReadByte();
                        //ownerid
			$this->Item_dwOwnerID[$i] =  $cNeoSerialMemory->ReadInt();
	}
	...
	public function Load_0112( &$cNeoSerialMemory )
	{
		...
		{
			self::LoadNode_0112( $i , $cNeoSerialMemory );
			//printf( "%03d:%03d <br>",$this->Item_InvenMain[$i],$this->Item_InvenSub[$i] );
		}
	}
        ...
        public function LoadChaPutOnItems( $Binary )
	{
		...
		$nSize = $cNeoSerialMemory2->ReadInt();
		//printf( "\$nSize = %d<br>\n" , $nSize );
